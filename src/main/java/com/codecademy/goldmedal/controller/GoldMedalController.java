...
public class GoldMedalController {
    ...
    private CountryMedalsListResponse getCountryMedalsListResponse(String countryName, String sortBy, boolean ascendingOrder) {
        ...
        switch (sortBy) {
            case "year":
                medalsList = goldMedalRepository.getByCountryOrderByYearAsc(countryName);// TODO: list of medals sorted by year in the given order
                break;
            case "season":
                medalsList = goldMedalRepository.getByCountryOrderBySeasonAsc(countryName);// TODO: list of medals sorted by season in the given order
                break;
            case "city":
                medalsList = goldMedalRepository.getByCountryOrderByCityAsc(countryName); // TODO: list of medals sorted by city in the given order
                break;
            case "name":
                medalsList = goldMedalRepository.getByCountryOrderByNameAsc(countryName);// TODO: list of medals sorted by athlete's name in the given order
                break;
            case "event":
                medalsList = goldMedalRepository.getByCountryOrderByEventAsc(countryName);// TODO: list of medals sorted by event in the given order
                break;
            default:
    ...
    private CountryDetailsResponse getCountryDetailsResponse(String countryName) {
        ...
        var summerWins = goldMedalRepository.getByCountryAndSeasonOrderByYearAsc(country.getName(),"Summer");// TODO: get the collection of wins at the Summer Olympics, sorted by year in ascending order
        ...
        var winterWins = goldMedalRepository.getByCountryAndSeasonOrderByYearAsc(country.getName(),"Winter");// TODO: get the collection of wins at the Winter Olympics
        ...
        var numberEventsWonByFemaleAthletes = goldMedalRepository.countByCountryAndGender(country.getName(),"Women"); // TODO: get the number of wins by female athletes
        var numberEventsWonByMaleAthletes = goldMedalRepository.countByCountryAndGender(country.getName(),"Men");// TODO: get the number of wins by male athletes
    ...
    private List<CountrySummary> getCountrySummaries(String sortBy, boolean ascendingOrder) {
        ...
        switch (sortBy) {
            ...
            case "medals":
            default:
                countries = countryRepository.getAllByOrderByNameDesc();// TODO: list of countries in any order you choose; for sorting by medal count, additional logic below will handle that
                break;
        }
